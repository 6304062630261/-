...
void _showExpensesDialog(BuildContext context, List<Map<String, dynamic>> expenses) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: expenses.map((expense) {
              return Text('ID: ${expense['id']}, Amount: ${expense['amount_transaction']}, Date: ${expense['date_user']}');
            }).toList(),
          ),
        ),
        actions: <Widget>[
